...
public class ArrayObject implements ArrayCommon {
    ...
    public void createData() {
        ...
        sort(arrName, new Comparator<Person>() {
            @Override
        ...
        while (true) {
            ...
            for (int i = 0; i < arrName.length; i++) {
                if (Objects.equals(name, arrName[i].getLastName())) {
